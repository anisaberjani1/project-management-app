    ...
    return ( 
        <div ref={(instance) => {
            ...
            {task.attachments && task.attachments.length > 0 && (
                <Image 
                    src={`https://pm-s3-images-final.s3.eu-central-1.amazonaws.com/${task.attachments[0].fileURL}`}
                    ...
                    <div className='flex -space-x-[6px] overflow-hidden'>
                        {task.assignee && (
                            <Image 
                                ...
                                src={`https://pm-s3-images-final.s3.eu-central-1.amazonaws.com/${task.assignee.profilePictureUrl!}`}
                        ...
                        {task.author && (
                            <Image 
                                ...
                                src={`https://pm-s3-images-final.s3.eu-central-1.amazonaws.com/${task.author.profilePictureUrl!}`}
